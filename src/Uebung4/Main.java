...
public class Main
{
    ...
    public static void main(String[] args){
        MenuePlaner menuePlaner = new MenuePlaner(getZutatenListe());
        menuePlaner.erstelleSpeiseplan();
        System.out.println(menuePlaner.getMenueFuerWochentag("Donnerstag"));
        System.out.println(menuePlaner.getMenueFuerWochentag("Mittwoch"));
    }
}
